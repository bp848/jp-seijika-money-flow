    ...
    extend: {
      colors: {
        ...
        "dark-tremor": {
          ...
          border: {
            DEFAULT: colors.gray[700], // Adjusted from 800 for better visibility if needed
          },
          ring: {
          ...
          content: {
            ...
            DEFAULT: colors.gray[500], // Should be gray[400] or gray[300] for better contrast on gray[900] bg
            emphasis: colors.gray[200],
            strong: colors.gray[50],
            inverted: colors.gray[950], // custom
          },
        },
      },
      borderRadius: {
